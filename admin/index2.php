<?php
  ...
  if ($saving == 1) { 
    ...
    fclose($fp); 
    echo "Haus Odin erfolgreich gespeichert!";
  }
?>
...
@import "javascript/jquery.datepick.css";
    ...
    <div class="wrapper">
      ...
      <div class="demo">
        <div style="margin-top:10px; font-size:18px; text-align:center;">Administrator Bereich - Belegung der Ferienwohnung Odin<br />
        ...
        <form name="form1" method="post" action="index2.php?saving=1">
          <div style="margin-top:10px;">
            <textarea name="data" cols="50" rows="10" id="datepicker"><?php $file = "kalender-odin.txt"; if (!empty($file)) {$file = file_get_contents("$file"); echo $file.',';}?></textarea>
          </div>
